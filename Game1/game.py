...
def normalise_input(user_input):
    ...
    'help'
    """
    user_input1 = remove_punct(user_input)
    user_input2 = remove_spaces(user_input1)
    user_input3 = user_input2.lower()
    return user_input3
...
def menu(exits):
    ...
    while True:
        ...
        input1 = normalise_input(player_input)

        if is_valid_exit(exits, input1) == True:
            return input1
